...
$( document ).ready(function() {
  ...
  tableUjiKelayakan = $('#table-uji-kelayakan').DataTable({ 
    ...
    "order": [], 
    "ajax": {
      "url": baseURL + "/inputJadwal/getdataUjiKelayakan",
      "type": "POST",
      "dataType": "JSON",
  ...
  //   var url = baseURL + `/inputJadwal/details?q=${id}&type=uji_kelayakan`;
  ...
  tableSUP = $('#table-sup').DataTable({ 
    ...
    "order": [], 
    "ajax": {
      "url": baseURL + "/inputJadwal/getdataSUP",
      "type": "POST",
      "dataType": "JSON",
      "dataSrc": function ( json ) {
        // console.log('Load Complete!');
    ...
    "columns": [
      ...
      }, 
      {
        ...
        render: function (data, type, row, meta) {
          ...
          switch(data) {
            ...
            break;
            case '2':
              res = '<span class="badge badge-info" style="font-size: 11px;">MENUNGGU JADWAL SIDANG</span>';
            break;
            case '3':
              if (row.userRules == '4') {
                /** Kaprodi */
                res = '<span class="badge badge-info" style="font-size: 11px;">MENUNGGU HASIL SIDANG</span>';
              }
      ...
      }, 
      {
        ...
        render: function (data, type, row, meta) {
          var ele = '';
          var url = baseURL + `/inputJadwal/details?q=${row.id}&type=sup`;
          ...
          case '0':
            ...
            case '2':
              ...
              if (row.userRules == '2') {
                /** Admin TU */
                ele = '<a href="'+ url + `&status=${row.status}` +'" class="btn btn-outline-secondary btn-sm" target="_parent">Klik untuk input jadwal</a>';
              }
            break;
            case '3':
              if (row.userRules == '1') {
  ...
  //   var url = baseURL + `/inputJadwal/details?q=${id}&type=sup`;
  //   return window.location.href = url;
  // });
  /** [END] - DatetTable SUP */
  ...
  tableSkripsi = $('#table-skripsi').DataTable({ 
    ...
    "order": [], 
    "ajax": {
      "url": baseURL + "/inputJadwal/getdataSkripsi",
      "type": "POST",
      "dataType": "JSON",
      "dataSrc": function ( json ) {
        // console.log('Load Complete!');
    ...
    "columns": [
      ...
      }, 
      {
        ...
        render: function (data, type, row, meta) {
          var ele = '';
          var url = baseURL + `/inputJadwal/details?q=${row.id}&type=skripsi`;
  ...
  //   var url = baseURL + `/inputJadwal/details?q=${id}&type=skripsi`;
  //   return window.location.href = url;
  // });
  /** [END] - DatetTable SUP */
