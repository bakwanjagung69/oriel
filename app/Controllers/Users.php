...
class Users extends BaseController {
    ...
    public function index() {
        ...
        return $this->template->Frontend("users/component-view-users");
    }
    ...
    public function form($id = '') {
        ...
        return $this->template->Frontend("users/component-view-users-form", $data);
    }
    ...
    public function updateData() {
        ...
        if ($post['nim'] == '') {
          return $this->response->setJson(array("code" => 405, "response" => 'NIM cannot be empty!'));
        }
