...
class AuthModel extends Model {
  ...
  public function doLogin($data, $G_recaptchaResponse = '') {
    $sql   = "SELECT * FROM {$this->table} WHERE `nim` = '{$data['nim']}' OR `email` = '{$data['nim']}'";
    ...
    if (!empty($row)) {
      ...
      $this->session->setFlashdata(['login_error' => "NIM atau Password tidak sesuai."]);
      return false;
    }
  }
