    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold" style="color: #0F0F10;">Formulir Skripsi</h6>
            </div>
            <div class="card-body">
        	 	<form action="void(0):javascript;" id="formSkripsi" method="POST" enctype="multipart/form-data">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-md-12">
			                <div class="form-group">
			                  	<label>Upload File Skripsi <small class="text-danger h6">*</small></label>
		                      	<div class="custom-file">
								    <input type="file" name="skripsi_files" class="custom-file-input" id="customFile" accept="application/pdf">
