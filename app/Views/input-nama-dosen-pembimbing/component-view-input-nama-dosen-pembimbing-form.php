        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form>
                ...
                <input type="hidden" name="ujiKelayakanJudulId" value="<?= $ujiKelayakanJudulId; ?>">
                <input type="hidden" name="kaprodiId" value="<?= $kaprodiId; ?>">
                     ...
                     <div class="column-sideby-side">
                        <div Id="wrapper">
                          <section>
                            <ul class="wrapper-ul">
                              <li class="wrapper-li">
                                <img class="lazy-load-img avatar-disp" src="<?= base_url("/files/loaderImg?loader=loader-image"); ?>" data-src="<?= base_url("/files/images?q={$mhsImages}"); ?>" width="180" height="180" alt="images" />
                                <div class="details">
                                  <p id="p1"><?= $mhsName; ?></p>
                                  <p id="p2"><?= $mhsNim; ?></p>
                                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        <label>Judul</label>
                        <input type="text" name="judul" class="form-control" placeholder="" readonly="readonly" value="<?= $judul; ?>">
                      </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                        <label>Jenis Ujian</label>
                        <input type="text" name="jenis_ujian" class="form-control" placeholder="" readonly="readonly" value="Uji Kelayakan pengajuan Judul">
                      </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" name="laporan_file" class="form-control" placeholder="" readonly="readonly" value="<?= $ujiKelayakanFilesName; ?>" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                          <button class="btn btn-outline-secondary" type="button" onclick='openfile("<?= base_url("/files/document?q={$ujiKelayakanFiles}"); ?>&mode=view")'>Buka File</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <?php if (session()->get('user_logged')['rules'] == '2') { ?>
                 <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                          <label>Upload Surat Tugas & Lembar Konsultasi</label>
                ...
                <div class="header-list-dosen">
                  <div class="label-list-dosen">
                    ...
                    <div class="sub-2">Nama - nama dosen pembimbing anda.</div>
                  </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                  <form action="void(0):javascript;" id="formPenugasanDosenPembimbing" method="POST" enctype="multipart/form-data">
                    <div>
                      <div class="form-group">
                        <label>Dosen</label>
                ...
                <hr>
                <table id="__tableAddDataDosenPembimbingListItems" class="table hover" style="width: 100%;">
                  <thead>
                    <tr>
                        <th>Nama Dosen</th>
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="saveDataPenugasanDosenPembimbing();">Save</button>
            </div>
        </div>
    </div>
</div>
