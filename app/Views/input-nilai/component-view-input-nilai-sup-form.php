    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            <div class="card-header">
              <div class="btn-save">
                <button type="button" class="btn btn-outline-secondary btn-back" onclick="Back();">
            ...
            <div class="card-body">
              <form>
                <input type="hidden" name="formulir_sup_id" value="<?= $data['formulir_sup_id']; ?>">
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="form-group-disabled">
                                <input type="text" name="tata_tulis_laporan" data-bobot="1" class="form-control only-number text-center sum-input" placeholder="">
                              </div>
                            </td>
                            <td>
                              <div class="form-group-disabled">
                                 <div class="input-group mb-3">
                                  ...
                                  <input type="text" name="nilaiXbobot-tata_tulis_laporan" class="form-control text-center disp-final-val" aria-describedby="basic-addon1" readonly="readonly">
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-group-disabled">
                                <input type="text" name="instrument_penelitian" data-bobot="2" class="form-control only-number text-center sum-input" placeholder="">
                              </div>
                            </td>
                            <td>
                              <div class="form-group-disabled">
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" name="nilaiXbobot-instrument_penelitian" class="form-control text-center disp-final-val" aria-describedby="basic-addon1" readonly="readonly">
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-group-disabled">
                                <input type="text" name="penugasaan_proposal_penelitian" data-bobot="1" class="form-control only-number text-center sum-input" placeholder="">
                              </div>
                            </td>
                            <td>
                              <div class="form-group-disabled">
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" name="nilaiXbobot-penugasaan_proposal_penelitian" class="form-control text-center disp-final-val" aria-describedby="basic-addon1" readonly="readonly">
                                </div>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>Penyajian materi dan penggunaan bahasa pada saat seminar</td>
                            <td class="text-center">1</td>
                            <td>
                              <div class="form-group-disabled">
                                <input type="text" name="penyajian_materi_penggunaan_bahasa" data-bobot="1" class="form-control only-number text-center sum-input" placeholder="">
                              </div>
                            </td>
                            <td>
                              <div class="form-group-disabled">
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" name="nilaiXbobot-penyajian_materi_penggunaan_bahasa" class="form-control text-center disp-final-val" aria-describedby="basic-addon1" readonly="readonly">
                                </div>
                              </div>
                            </td>
                          </tr>
                        ...
                        <div class="form-group">
                          <label>*Kesimpulan</label>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kesimpulan" id="Radios1" value="Layak" checked="checked">
                              <label class="form-check-label" for="Radios1">
                                Layak
                              </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="kesimpulan" id="Radios2" value="Tidak Layak">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="div-btn-action">
                            <button type="button" class="btn btn-primary btn-block btn-col-navy btn-save-nilai" onclick="simpanNilaiSUP(event);">
                                Simpan Nilai
                            </button>
                          </div>
                        </div>
