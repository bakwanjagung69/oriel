    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold" style="color: #0F0F10;">Formulir Uji Kelayakan</h6>
            </div>
            <div class="card-body">
        	 	<form action="void(0):javascript;" id="formUjiKelayakan" method="POST" enctype="multipart/form-data">
